  ...
  <form id="outofthebox-options" method="post" action="options.php">
    ...
    <div class="wrap">
      ...
      <div id="" class="outofthebox-panel outofthebox-panel-left">      
        ...
        <ul class="outofthebox-nav-tabs">
          <li id="settings_help_tab" data-tab="settings_help"><a href="https://codecanyon.net/item/outofthebox-google-drive-plugin-for-wordpress/6219776?ref=_DeLeeuw_" target="_blank" style="color:#0078d7;">Google Drive <i class="fa fa-external-link-square" aria-hidden="true"></i></a></li>
          <li id="settings_help_tab" data-tab="settings_help"><a href="https://codecanyon.net/item/shareonedrive-onedrive-plugin-for-wordpress/11453104?ref=_DeLeeuw_" target="_blank" style="color:#0078d7;">OneDrive <i class="fa fa-external-link-square" aria-hidden="true"></i></a></li>
