  ...
  $(window).load(function () {
          ...
          $.ajax({
            ...
            success: function (result) {
              if (result instanceof Array) {
                ...
                $(".OutoftheBox[data-token='" + listtoken + "'] .jp-jplayer").css('opacity', '100');
                ...
                $(".OutoftheBox[data-token='" + listtoken + "'] .jp-title").html(OutoftheBox_vars.str_xhrError_title);
    ...
    $('.OutoftheBox.media.video').each(function () {
      ...
      oftb_playlists[listtoken] = new jPlayerPlaylist({
        ...
        setmedia: function (e) {
          $(".OutoftheBox[data-token='" + listtoken + "'] .jp-video-play").hide();
        },
        ready: function (e) {
          $(".OutoftheBox[data-token='" + listtoken + "'] .jp-title").show();
          var data = {
          ...
          $(".OutoftheBox[data-token='" + listtoken + "'] object").height($(".OutoftheBox[data-token='" + listtoken + "'] .jp-jplayer").height() - 50);
          $(".OutoftheBox[data-token='" + listtoken + "'] .jp-video-play").height($(".OutoftheBox[data-token='" + listtoken + "'] .jp-jplayer").height() - 50);
        ...
        loadedmetadata: function (e) {
          ...
          if (e.jPlayer.status.videoHeight !== 0 && e.jPlayer.status.videoWidth !== 0) {
            ...
            if ($(".OutoftheBox[data-token='" + listtoken + "'] .jp-jplayer img").attr('src').indexOf("/css/images/audiothumb.png") >= 0) {
              $(".OutoftheBox[data-token='" + listtoken + "'] .jp-jplayer img").hide();
            }
          }

          if (e.jPlayer.status.paused) {
            $(".OutoftheBox[data-token='" + listtoken + "'] .jp-video-play").show();
          }
        },
        waiting: function (e) {
          var videoselector = $(".OutoftheBox[data-token='" + listtoken + "'] object");
    ...
    function animatePlaylist(listtoken) {
      if ($(".OutoftheBox[data-token='" + listtoken + "'] .jp-playlist").hasClass('hideonstart')) {
        ...
        $(".OutoftheBox[data-token='" + listtoken + "'] .jp-gui, .OutoftheBox[data-token='" + listtoken + "'] .jp-playlist").hover(
                function () {
                  $(".OutoftheBox[data-token='" + listtoken + "'] .jp-playlist").stop().slideDown("slow");
                },
                function () {
                  $(".OutoftheBox[data-token='" + listtoken + "'] .jp-playlist").stop().slideUp("slow");
                });
      }
    }
  });
