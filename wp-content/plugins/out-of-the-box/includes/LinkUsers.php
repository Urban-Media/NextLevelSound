    ...
    public function render() {
        ...
        <div class="outofthebox admin-settings">
          ...
          <div class="outofthebox-header">
            ...
            <div class="outofthebox-title"><?php _e('Link Users manually to Private Folders', 'outofthebox'); ?></div>
          </div>
    ...
    public function column_default($item, $column_name) {
        switch ($column_name) {
            ...
            case 'buttons':
                ...
                $buttons_html = '<a href="#" title="' . __('Create link with Private Folder', 'outofthebox') . '" class="linkbutton ' . (($has_link) ? 'hidden' : '') . '" data-user-id="' . $item['id'] . '"><i class="fa fa-link" aria-hidden="true"></i> <span class="linkedto">' . __('Link to Private Folder', 'outofthebox') . '</span></a>';
                $buttons_html .= '<a href="#" title="' . __('Break link with Private Folder', 'outofthebox') . '" class="unlinkbutton ' . (($has_link) ? '' : 'hidden') . '" data-user-id="' . $item['id'] . '"><i class="fa fa-chain-broken" aria-hidden="true"></i> <span class="linkedto">' . __('Unlink', 'outofthebox') . '</span></a>';
