...
$form_id = get_option( 'lifterlms_gravityforms_registration_form', false );
...
// get the remaining options
	...
	$form_title = ( 'yes' === get_option( 'lifterlms_gravityforms_registration_form_show_title', 'no' ) ) ? true : false;
	$form_desc = ( 'yes' === get_option( 'lifterlms_gravityforms_registration_form_show_desc', 'no' ) ) ? true : false;
	$form_ajax = ( 'yes' === get_option( 'lifterlms_gravityforms_registration_form_usa_ajax', 'yes' ) ) ? true : false;

}
?>

<?php do_action( 'llms_gforms_before_registration_form' ); ?>

<?php echo do_shortcode( '[gravityform id="' . $form_id . '" title="'. $form_title .'" description="' . $form_desc . '" ajax="' . $form_ajax . '"]' ); ?>

<?php do_action( 'llms_gforms_after_registration_form' ); ?>
