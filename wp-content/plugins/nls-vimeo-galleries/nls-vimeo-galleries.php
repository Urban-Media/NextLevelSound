<?php
/*
Plugin Name: NLS Vimeo Galleries Widget Plugin
Plugin URI:
Description: Adds a Vimeo gallery widget option for use on lesson sidebars
Version: 1.0
Author: Urban Media
 ...
 * Register the widget
 */
add_action('widgets_init', create_function('', 'return register_widget("NLS_Vimeo_Galleries_Widget");'));

/**
 * Class NLS_Vimeo_Galleries_Widget
 */
class NLS_Vimeo_Galleries_Widget extends WP_Widget
{
	/** Basic Widget Settings */
	const WIDGET_NAME = "NLS Vimeo Galleries";
	const WIDGET_DESCRIPTION = "Adds a Vimeo gallery widget option for use on lesson sidebars";
