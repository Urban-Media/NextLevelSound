<?php
/*
Plugin Name: NLS Resources Plugin
Plugin URI:
Description: Adds resources functionality to courses, sections and lessons
Version: 1.0
Author: Urban Media
 ...
 * Register the widget
 */
add_action('widgets_init', create_function('', 'return register_widget("NLS_Resources");'));

/**
 * Class NLS_Resources
 */
class NLS_Resources extends WP_Widget
{
	/** Basic Widget Settings */
	const WIDGET_NAME = "NLS Resources";
	const WIDGET_DESCRIPTION = "Adds resource functionality for course/section/lesson sidebars";
    ...
    if (!is_plugin_active('advanced-custom-fields/acf.php')) {
      ...
      wp_die( __( 'NLS Resources requires Advanced Custom Fields to be installed and activated.', 'NLS_Resources' ) );
    }
