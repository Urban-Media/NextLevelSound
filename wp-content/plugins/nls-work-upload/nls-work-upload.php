<?php
/*
Plugin Name: NLS Work Upload Widget
Plugin URI:
Description: Adds a work upload widget to courses, sections and lessons
Version: 1.0
Author: Urban Media
 ...
 * Register the widget
 */
add_action('widgets_init', create_function('', 'return register_widget("NLS_Work_Upload");'));

/**
 * Class NLS_Resources
 */
class NLS_Work_Upload extends WP_Widget
{
	/** Basic Widget Settings */
	const WIDGET_NAME = "NLS Work Upload";
	const WIDGET_DESCRIPTION = "Adds a work upload widget for course/section/lesson sidebars";
    ...
    if (!is_plugin_active('advanced-custom-fields/acf.php')) {
      ...
      wp_die( __( 'NLS Work Upload requires Advanced Custom Fields to be installed and activated.', 'NLS_Recommended_Plugins' ) );
    }
    ...
    global $post;
        ...
        <h2 class="sideblock_title text-center white_text">
          Upload Your Work In Progress
        </h2>
        <p>
          WIP needs Dropbox integration
        </p>
