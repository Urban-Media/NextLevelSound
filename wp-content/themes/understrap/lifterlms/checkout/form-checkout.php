...
<form action="" class="llms-checkout llms-checkout-cols-<?php echo apply_filters( 'llms_checkout_columns', ! $free ? $cols : 1, $plan ); ?>" method="POST" id="llms-product-purchase-form">
	...
	<div class="container nls_course_nav">
		<div class="row section_bottom_block_header white_text uppercase">
			<div class="col-12">
				<h4 class="llms-form-heading uppercase white_text text-center">
					<?php if ( ! $free ) : ?>
		...
		<div class="row">
			<div class="col-12 grey_block section_bottom_block" style="margin-top: 0px !important; padding-top: 20px;">
	...
	<div class="container section_bottom_block" style="margin-bottom: 50px;">
		<div class="row section_bottom_block_header white_text uppercase">
			<div class="col-12">
				<h4 class="llms-form-heading uppercase white_text text-center">
					<?php if ( ! $free ) : ?>
		...
		<div class="row grey_block nls_course_nav">
			<div class="col-12">
