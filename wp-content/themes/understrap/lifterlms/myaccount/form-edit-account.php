...
<div class="llms-person-form-wrapper">
	...
	<form method="post" class="llms-person-form edit-account nls_course_nav" style="padding-top: 10px;">
		...
		<footer class="llms-form-fields">
			...
			<?php llms_form_field( array(
				'columns' => 3,
				'classes' => 'nls_rounded_button teal_button white_text uppercase text-center',
